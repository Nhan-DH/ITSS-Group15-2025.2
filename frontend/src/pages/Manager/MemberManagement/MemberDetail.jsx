    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Hồ sơ Hội viên</h1>
            <p className="mt-1 text-sm text-gray-500">Quản lý thẻ tập và lịch sử của {mockMember.fullName}</p>
          </div>
        </div>
        <Link to={`/manager/members/${id}/edit`}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex-1 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
            <h3 className="flex items-center gap-2 text-lg font-bold text-gray-900 dark:text-white mb-4">
              <Activity className="h-5 w-5 text-green-500" /> Lịch sử hoạt động
            </h3>
